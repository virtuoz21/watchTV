...
function Home () {
    ...
    const actionFilms = useReqGenre('http://dolphin-app-pc6ii.ondigitalocean.app/article/byGenre/Action');
    const comedyFilms = useReqGenre('http://dolphin-app-pc6ii.ondigitalocean.app/article/byGenre/Comedy');
